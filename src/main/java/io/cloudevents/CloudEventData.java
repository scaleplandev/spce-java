...
public class CloudEventData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /**
   * Serializes this CloudEventData to a ByteBuffer.
  ...
  /**
   * Deserializes a CloudEventData from a ByteBuffer.
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      case 0:
        value = (java.util.Map<java.lang.CharSequence, java.lang.Object>) value$;
        break;
      default:
        throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  ...
  /**
   * Creates a new CloudEventData RecordBuilder.
   * @return A new CloudEventData RecordBuilder
   */
  public static io.cloudevents.CloudEventData.Builder newBuilder() {
    return new io.cloudevents.CloudEventData.Builder();
  }

  /**
   * Creates a new CloudEventData RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new CloudEventData RecordBuilder
   */
  public static io.cloudevents.CloudEventData.Builder newBuilder(io.cloudevents.CloudEventData.Builder other) {
    if (other == null) {
      return new io.cloudevents.CloudEventData.Builder();
    } else {
      return new io.cloudevents.CloudEventData.Builder(other);
    }
  }

  /**
   * Creates a new CloudEventData RecordBuilder by copying an existing CloudEventData instance.
   * @param other The existing instance to copy.
   * @return A new CloudEventData RecordBuilder
   */
  public static io.cloudevents.CloudEventData.Builder newBuilder(io.cloudevents.CloudEventData other) {
    if (other == null) {
      return new io.cloudevents.CloudEventData.Builder();
    } else {
      return new io.cloudevents.CloudEventData.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CloudEventData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cloudevents.CloudEventData.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing CloudEventData instance
     * @param other The existing instance to copy.
     */
    private Builder(io.cloudevents.CloudEventData other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
     ...
     * @return This builder.
     */
    public io.cloudevents.CloudEventData.Builder setValue(java.util.Map<java.lang.CharSequence, java.lang.Object> value) {
     ...
     * @return This builder.
     */
    public io.cloudevents.CloudEventData.Builder clearValue() {
      value = null;

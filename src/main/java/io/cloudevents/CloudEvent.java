...
public class CloudEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.cloudevents.CloudEvent.Builder newBuilder() {
    return new io.cloudevents.CloudEvent.Builder();
  }
   ...
   * @return A new CloudEvent RecordBuilder
   */
  public static io.cloudevents.CloudEvent.Builder newBuilder(io.cloudevents.CloudEvent.Builder other) {
    if (other == null) {
      return new io.cloudevents.CloudEvent.Builder();
    } else {
      return new io.cloudevents.CloudEvent.Builder(other);
    }
  }
   ...
   * @return A new CloudEvent RecordBuilder
   */
  public static io.cloudevents.CloudEvent.Builder newBuilder(io.cloudevents.CloudEvent other) {
    if (other == null) {
      return new io.cloudevents.CloudEvent.Builder();
    } else {
      return new io.cloudevents.CloudEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CloudEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cloudevents.CloudEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cloudevents.CloudEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.attribute)) {
        this.attribute = data().deepCopy(fields()[0].schema(), other.attribute);
     ...
     * @return This builder.
     */
    public io.cloudevents.CloudEvent.Builder setAttribute(java.util.Map<java.lang.CharSequence, java.lang.Object> value) {
     ...
     * @return This builder.
     */
    public io.cloudevents.CloudEvent.Builder clearAttribute() {
      attribute = null;
     ...
     * @return This builder.
     */
    public io.cloudevents.CloudEvent.Builder setData(java.lang.Object value) {
     ...
     * @return This builder.
     */
    public io.cloudevents.CloudEvent.Builder clearData() {
      data = null;
